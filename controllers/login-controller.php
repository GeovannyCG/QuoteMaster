...
$user = $_POST['rfclUser']; // Variable que almacena el valor del campo de correo electrónico (email) proporcionado por el usuario en el formulario de inicio de sesión.
...
try {
    ...
    $loginObj->validationUser($user, $pass);
} catch (\Throwable $th) {
    ...
    echo "Lo sentimos, algo no salio bien";
}
?>