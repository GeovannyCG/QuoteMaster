...
try {
    if (isset($_SESSION["rfc"])) {
        ...
        $pedidosCamino = $HomeModel->showPedidosCurso();
        $accesoAlmacen = $HomeModel->showSolAccsAlmacen();

        $showReporters = $HomeModel->showReportsPedidos();
        $showPedidosEnd = $HomeModel->showEndPedidos();
