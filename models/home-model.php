...
class Home
{
    ...
    {
        $queryshowPedidosCurso = "SELECT * FROM pedidos_quote WHERE estado_entrega_p = 'preparando' OR estado_entrega_p = 'encamino' OR estado_entrega_p = 'pendiente'";
    ...
    {
        $queryShowSolAccsAlmacen = "SELECT * FROM pedidos_quote WHERE estado_almacen_p = 'en revision' OR estado_almacen_p = 'retenido'";
    ...
    {
        $queryEndPedidos = "SELECT * FROM reportes_quote";
