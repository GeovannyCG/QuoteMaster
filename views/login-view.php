    ...
    <div class="container-main">
        <div class="section1" style="background-color: white;">
            ...
            <div class="container-form">
                <form id="form-login" action="./Acces" method="post"> <!--Hay que poner estar vainas correctas-->
                    <h1>Ingresar</h1>
                    <div class="message-error">
                        <span id="rfc-message" style="color: red;"></span>
                    </div>
                    <div class="mb-3">
                        <input type="text" class="form-control" name="rfclUser" placeholder="Ingresa tu RFC" id="rfcInput" aria-describedby="emailHelp" />
                    </div>
                    <div class="message-error">
                        <span id="password-message" style="color: red;"></span>
                    </div>
                    <div class="mb-3">
                        <input placeholder="Ingresa tu contraseña" name="passUser" type="password" class="form-control" id="passwordInput" />
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <div class="input_field captch_box">
                            <input type="text" value="" disabled id="catpcha-screen" oncopy="return false;"/>
                            <button id="refresh-button" class="refresh_button">
                        ...
                        <span id="message-captcha" style="color: orange;"></span>
                    </div>
                    <div class="input_field button">
                        <button type="submit" id="btn-submit" class="btn btn-primary">Ingresar</button>
                    </div>
                </form>
            </div>
